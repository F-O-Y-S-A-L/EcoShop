        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center gap-8">
            <Link href="/" className="flex items-center space-x-2 group">
              ...
              <span className="font-display text-2xl font-black tracking-tighter text-eco-dark">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link
                href="/shop"
                className="text-xs font-black uppercase tracking-widest text-eco-dark/60 hover:text-eco-primary transition-colors"
              >
                Shop
              </Link>
              <Link
          ...
          <div className="hidden md:flex items-center gap-8">
            <div className="flex items-center gap-6 text-sm">
              {user ? (
                ...
                <Link
                  href="/login"
                  className="text-xs font-black uppercase tracking-widest text-eco-dark"
                >
                  Login
                </Link>
              )}
              ...
              <Link
                href="/cart"
                className="flex items-center gap-3 px-6 py-2.5 bg-eco-dark text-white rounded-full hover:bg-eco-primary transition-all shadow-lg hover:shadow-eco-primary/30"
              >
            ...
            <div className="px-4 pt-6 pb-8 space-y-6">
              <div className="space-y-1">
                <Link
                  ...
                  className="block py-3 text-xs font-black uppercase tracking-widest text-eco-dark/60 hover:text-eco-primary transition-colors border-b border-eco-bg"
                >
                  Shop
                </Link>
                <Link
