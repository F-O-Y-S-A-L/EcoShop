...
export default function AboutPage() {
  const values = [
    {
      ...
      description:
        "We don't just stock snacks; we hunt them. From limited-edition Japanese chips to artisan Belgian chocolates, if it moves the needle, it's on CRAVE.",
    },
    {
      icon: Shield,
      title: "The Taste Protocol",
      description:
        "Every single item in our inventory passes a rigorous blind-taste test by our board of curators. If it doesn't spark joy, it doesn't make the cut.",
    },
    {
      icon: Zap,
      title: "Hyper-Speed Logistics",
      description:
        "Cravings don't wait, and neither do we. Our supply chain is optimized for the 'I need it now' generation. Global flavors, delivered at turbo speed.",
    },
  ];
  ...
  const milestones = [
    {
      year: "2023",
      event: "CRAVE. founded by a group of obsessive snack hunters.",
    },
    {
      year: "2024",
      event: "Reached 500+ global artisan partners across 12 countries.",
    },
    {
      year: "2025",
      event: "Launched the Taste Protocol — our gold-standard for quality.",
    },
    {
      year: "2026",
      event: "Achieved 100% Carbon Neutral Delivery for all orders.",
    },
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 py-12 space-y-12 md:px-4 md:py-24 md:space-y-32">
      ...
      <section className="text-center space-y-8 max-w-4xl mx-auto">
        ...
        >
          Snacking is <br />{" "}
          <span className="text-eco-primary underline decoration-eco-gray underline-offset-8">
            a lifestyle
          </span>
          , not a filler.
        </motion.h1>
        ...
        >
          CRAVE. was born from the frustration of boring cupboards. We've
          curated the world's most addictive, high-quality, and ethical snacks
          so you can indulge with zero compromise on taste or integrity.
        </motion.p>
      </section>
          ...
          <div className="flex-1 space-y-12">
            ...
            <div className="space-y-8">
              {milestones.map((item, i) => (
                <div
                  key={item.year}
                  className="flex items-center md:gap-10 md:items-start"
                >
                  <span className="font-display italic text-3xl text-eco-primary w-24 shrink-0">
                    {item.year}
                  </span>
                  <p className="text-sm font-medium pt-2 text-white/70 leading-relaxed uppercase tracking-tight">
                    {item.event}
                  </p>
                </div>
              ))}
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-12 py-20 border-y border-eco-gray text-center overflow-hidden">
        <div>
          ...
          <p className="text-[10px] font-black uppercase tracking-[0.3em] text-eco-primary mt-4">
            Orders Fulfilled
          </p>
        </div>
        <div>
      ...
      <section className="text-center space-y-12 bg-eco-primary py-10 rounded-4xl md:py-32 md:rounded-[5rem] text-white shadow-2xl relative overflow-hidden group">
        ...
        <div className="relative z-10 space-y-8">
          ...
          <p className="max-w-md mx-auto text-white/80 font-medium text-sm leading-relaxed">
            Stop eating boring snacks. Join the CLUB and get access to our
            exclusive monthly drops and members-only pricing.
          </p>
          <Link
            href={"/shop"}
