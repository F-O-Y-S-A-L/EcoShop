          ...
          >
            ...
            <div className="space-y-4">
              <p className="text-gray-500 text-sm mb-6">
                Choose your preferred mobile banking method. We use 256-bit AES
                encryption.
              </p>
              ...
              >
                ...
                <div
                  className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${form.paymentMethod === "bKash" ? "border-eco-primary" : "border-gray-300"}`}
                >
                  {form.paymentMethod === "bKash" && (
                    <div className="w-3 h-3 bg-eco-primary rounded-full"></div>
                  )}
                </div>
              </button>
              ...
              >
                ...
                <div
                  className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${form.paymentMethod === "Nagad" ? "border-eco-primary" : "border-gray-300"}`}
                >
            ...
            <div className="pt-6 border-t border-eco-bg flex justify-between items-center">
              <div className="space-y-1">
                <p className="text-[8px] md:text-xs uppercase tracking-widest text-gray-400 font-bold">
                  Payable Amount
                </p>
                <p className="text-xl md:text-4xl font-display text-eco-primary font-bold">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-500 max-w-sm mx-auto text-lg leading-relaxed">
                Your ecological footprint was just offset. We'll send you an
                update once your package is on its way.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-4 max-w-sm mx-auto">
              <button
                onClick={() => router.push("/profile")}
                className="bg-white border border-eco-bg px-6 py-4 rounded-full font-bold text-sm"
              >
                View Orders
              </button>
              <button
                onClick={() => router.push("/shop")}
                className="bg-eco-primary text-white px-6 py-4 rounded-full font-bold text-sm"
              >
                Keep Shopping
              </button>
            </div>
