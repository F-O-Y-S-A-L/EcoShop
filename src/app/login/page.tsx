    ...
    <div className="max-w-md mx-auto px-4 py-20">
      <div className="bg-white p-10 rounded-[3rem] border border-eco-bg shadow-xl space-y-10">
        <div className="text-center space-y-2">
          <h1 className="text-4xl font-display font-bold italic">Welcome Back</h1>
          <p className="text-gray-400 text-sm italic underline decoration-eco-secondary decoration-2 underline-offset-4">Continue your sustainable journey.</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4">
           ...
           >
             ...
             <span className="text-[10px] uppercase font-bold tracking-widest">Sign in with Google</span>
           </button>
        </div>

        <div className="relative">
          <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-eco-bg"></div></div>
          <div className="relative flex justify-center text-xs uppercase tracking-[0.3em] font-bold text-slate-300"><span className="bg-white px-4">OR</span></div>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mx-1">Email Essence</label>
            <div className="relative">
          ...
          <div className="space-y-2">
             <label className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mx-1">Secure Key</label>
             <div className="relative">
        ...
        <p className="text-center text-xs text-gray-400">
          New here? <Link href="/register" className="text-eco-primary font-bold hover:underline">Create an Account</Link>
        </p>
      </div>
    </div>
  );
