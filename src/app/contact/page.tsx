  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success(
          data.simulated
            ? "Mission Logged (Local). Connect SMTP for real emails."
            : "Message received by the ecosystem.",
        );
    ...
    <div className="max-w-7xl mx-auto px-4 py-20 space-y-24">
      ...
      <section className="text-center space-y-6">
        ...
        <p className="text-gray-500 max-w-xl mx-auto font-medium uppercase tracking-tight text-sm">
          Have a request? A complaint? Or just want to suggest a new global
          drop? Our team is listening.
        </p>
      </section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
        ...
        <div className="space-y-12">
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-400 text-sm font-medium uppercase tracking-tight">
                  122 Snack District, Global City, GC 404
                </p>
              </div>
            </div>
          ...
          <div className="p-8 bg-eco-dark rounded-[3rem] text-white relative overflow-hidden shadow-2xl">
            ...
            <h4 className="text-xl font-display font-bold italic mb-4">
              Turbo Response
            </h4>
            <p className="text-sm text-white/50 leading-relaxed uppercase tracking-tight">
              Our average response time for valid drop requests is under 4
              hours. No time for waiting.
            </p>
          </div>
        </div>
        ...
        >
          <div className="space-y-8">
            <div className="space-y-3">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-eco-primary px-2">
                Identification
              </label>
              <input
                type="text"
